...
| `verify_offline.py` (offline gate) | **EXIT 0** — `python_runtime` va `node_runner` **`PASS_WITH_RECORDED_BLOCKED`** (13 + 11 qayd etilgan; yangi qizil = FAIL). Dalil: `docs/verification/local-20260926T061554347843Z/` |
